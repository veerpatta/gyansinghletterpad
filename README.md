...
अभी हेडर **CSS से बनी नक़ल** है (फ़ोटो और चुनाव‑चिह्न की जगह ख़ाली डिब्बे दिख रहे हैं)।
...
वैकल्पिक: `assets/photo.png` और `assets/logo.png` डालने पर CSS वाले हेडर के ख़ाली डिब्बे भर जाएँगे।
